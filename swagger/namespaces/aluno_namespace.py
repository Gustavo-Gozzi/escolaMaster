...
from aluno.model_aluno import lista_alunos, aluno_by_id,
post_alunos, put_Alunos, delete_aluno, resetaAlunos, existe_aluno, calcula_idade, media, empty
...
class AlunosResource(Resource):
    ...
    def post(self):
        ...
        response, status_code = post_alunos(data)
...
class AlunoIdResource(Resource):
    ...
    def get(self, id_aluno):
        ...
        return aluno_by_id(id_aluno)

    @alunos_ns.expect(aluno_model)
    def put(self, id_aluno):
        """Atualiza um aluno pelo ID"""
        data = alunos_ns.payload
        put_Alunos(id_aluno, data)
        return data, 200
